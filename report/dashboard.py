...
class ReportDropdown(Dropdown):
    ...
    def component_data(self, model, *args):
...
class LineChart(MatplotlibViz):
    ...
    def visualization(self, model, asset_id):
        ...
        if not hasattr(model, "event_counts"):
            model, asset_id = asset_id, model
...
class BarChart(MatplotlibViz):
    ...
    def visualization(self, model, asset_id):
        ...
        if not hasattr(model, "model_data"):
            model, asset_id = asset_id, model
...
class Report(CombinedComponent):
    ...
    def __call__(self, entity_id, model):
        # Forzar orden correcto en todos los children
        return super().__call__(model, entity_id)
